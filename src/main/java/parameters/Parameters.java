...
public final class Parameters {
    ...
    public static final float NOISE_SCALE = .0125f;
    public static final int STEP = 4;
    public static final float OFFSET_RANGE = .25f;
    public static final int LINE_LENGTH = 250;
    public static final float LINE_STEP_SIZE = .5f;
    public static final int BORDER_SIZE = 50;
    public static final float NOISE_RING_RADIUS = 100;
    public static final float NOISE_RING_FACTOR = 4;
    public static final float NOISE_MIN_DIRECTIONS = 2;
    public static final float NOISE_DIRECTIONS_FACTOR = 2;
    public static final Color BACKGROUND_COLOR = new Color(247);
    public static final Color STROKE_COLOR = new Color(25.5f, 25.5f);
    public static final Color BORDER_COLOR = new Color(12.75f);
